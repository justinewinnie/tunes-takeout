Rails.application.routes.draw do
  ...
  post '/suggestions/:suggestion_id/favorite' =>'suggestions#favorite', as: 'favorite'
  # delete '/suggestions/:suggestion_id/favorite' => 'suggestions#destroy', as: 'delete_favorite'
